...
set4 <- read_csv("2023/set4_dataviz.csv") %>%
  clean_names()
...
# save visuals ----
ggsave("2023/figures/avg_tool_use.png", p,
       device = ragg::agg_png, dpi = 350, width = 12, height = 10, bg = "white")

ggsave("2023/figures/fav_tools_light.png", fav_light,
       device = ragg::agg_png, dpi = 300, width = 12, height = 10, bg = "white")

ggsave("2023/figures/fav_tools_dark.png", fav_dark,
       device = ragg::agg_png, dpi = 300, 
       width = 12, height = 10, bg = "black")

# flow fields ----
source("2023/flow_field_setup.R")
...
ggsave("2023/figures/fav_tools_flow_all.png", flow1,
...
ggsave("2023/figures/fav_tools_flow_20.png", flow2,
       device = ragg::agg_png, dpi = 325, 
